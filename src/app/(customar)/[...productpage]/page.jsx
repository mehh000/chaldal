...
function ProductDetail({ params }) {
  const productID = params.productpage[1];
 ...
 // console.log('user:', user.uid);
  ...
  return (
    <>
      {
        loading ? <div role="status" class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center">
